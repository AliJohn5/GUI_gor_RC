...
#include "include/template_gui_package/mainwindow3.h"
...
QT_MOC_LITERAL(7, 49, 8) // "not_hide"

    },
    "MainWindow3\0dataToSend\0\0data\0dataopen\0"
    "f\0sendData\0not_hide"
};
...
void MainWindow3::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->not_hide(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MainWindow3::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWindow3::dataToSend)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MainWindow3::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWindow3::dataopen)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MainWindow3::dataToSend(int _t1)
{
...
// SIGNAL 1
void MainWindow3::dataopen(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
